...
char arriere[] = {60,100,60,60,100,60,100,100}; // créé un array ‘arriere[]’
...
void recule() {
  for(int n=0;n<4;n++){
    servoAvant.write(arriere[2*n]);            // envoie au moteur une valeur pair de la liste arriere[]
    servoArriere.write(arriere[(2*n)+1]);      // envoie au moteur une valeur impair de la liste
    delay(350);
  }
}
// -----------------------------------//
